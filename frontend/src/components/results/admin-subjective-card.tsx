...
import type { SubjectiveQuestion, SubjectiveAnswer } from "@/types/result"

interface AdminSubjectiveCardProps {
    question: SubjectiveQuestion
    answer?: SubjectiveAnswer
    questionNumber: number
}

export const AdminSubjectiveCard = ({ question, answer, questionNumber }: AdminSubjectiveCardProps) => {
    return (
